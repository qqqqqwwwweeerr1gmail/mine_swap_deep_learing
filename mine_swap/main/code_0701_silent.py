...
if __name__ == '__main__':
    ...
    global_timestamp = int(time.time() * 1_000_000)
    ...
    is_totally_init = False
    is_totally_init = True
    ...
    try:
        ...
        print(rate_reward)
        print('random play win rate', total_reward / memo_episode)
    except:
        pass
    ...
    if is_escape_knowledge:
        ...
        knowledge_time = global_timestamp
        ...
        for con in sorted_fo_content:
            ...
            for a in num_grid:
                for b in mine_forcast_grid:
                    ...
                    print(EDR)
                    write_flag, edr_no = write_edr(EDR)
                    if write_flag:
    ...
    try:
        ...
        print(rate_reward)
        print('play with memory win rate', total_reward / memo_episode)
    except:
        pass
